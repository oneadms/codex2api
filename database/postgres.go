...
func accountChannelFilterSQL(channel, upstreamTypeExpr string) string {
	...
	case UpstreamChannelCodex:
		...
		return ` AND ` + upstreamTypeExpr + ` NOT IN ('grok', 'antigravity', 'traecn', 'claude')`
	default:
		return ""
	}
}
