...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				traecn_default_model TEXT DEFAULT 'auto',
				traecn_test_model TEXT DEFAULT 'auto',
	...
	columns := []struct {
		...
		{"system_settings", "traecn_config", "TEXT DEFAULT '{}'"},
		{"system_settings", "codex_ticket_config", "TEXT DEFAULT '{}'"},
